...
export default function CreateBotDetailsPage() {
  ...
  const { botName, setBotName, websiteUrl, setWebsiteUrl, discoveryMethod, setDiscoveryMethod, isDiscovering, localError, setLocalError, discoverUrls } = useCreateBotFlow()
