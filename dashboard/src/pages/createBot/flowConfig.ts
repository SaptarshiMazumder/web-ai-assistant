...
const DEFAULT_SCREEN_DEFINITIONS: Record<string, CreateBotScreen> = {
  ...
  reservation_destination: {
    ...
    subtitle: 'When a customer asks your agent about making a reservation, where should they be sent?',
    fieldLabel: 'Use a different link instead (optional)',
    fieldPlaceholder: 'https://your-restaurant.com/reserve',
    fieldHelper: 'Only fill this in if you want customers to go somewhere other than the link above.',
    fallbackNotice: '',
    visibility: {
